...
namespace Infraestructure.Migrations
{
    ...
    [Migration("20210502013744_Final_SecondMigration")]
    partial class Final_SecondMigration
    {
            ...
            modelBuilder.Entity("ApplicationCore.Entities.Registro_Pago", b =>
                {
                    ...
                    b.Property<DateTime>("Fecha_Pago")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 5, 1, 19, 37, 42, 524, DateTimeKind.Local).AddTicks(3074));
